...
2. Make a directory for each challenge in the respective *category-directory*. Everything related to that challenge should be present in that directory.The different category directories will be : 
    - Crypto
    - Forensics
...
4. If you want to provide any huge files then upload them to your drive and provide a link to that files.
